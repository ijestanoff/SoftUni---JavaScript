const recipeSelection = {
  ...
  getRecipesByCategory(recipes, category) {
    ...
    let test = filteredRecipes.map((recipe) => recipe.title);
    return test;
  },
};

console.log(recipeSelection.getRecipesByCategory([{ title:"Spicy", category: "Asian" }, { title:"Lut", category: "Bulg" }], "Asian"))
